...
def build_x_y_r_t(args):
    ...
    y_dist = args.post_radius + args.tube_radius - args.wall_thickness
    ...
    tube_args.length = x_dist + args.post_radius
    tube_args.num_time_steps = time_divisions[1]
    x_t, y_t, r_t = generate_tube.build_x_y_r_t(tube_args)

    if args.post_radius - args.wall_thickness < args.tube_radius:
    ...
    final_rotation = math.asin(args.tube_radius / (args.post_radius - args.wall_thickness)) * 180 / math.pi
    ...
    helix_args.helix_radius = args.post_radius + args.tube_radius - args.wall_thickness
    ...
    helix_args.helix_radius = args.tube_radius
