...
python generate_hypotrochoid.py --hypoA 12 --hypoB 3 --hypoC 6 --slope_angle 8 --scale 6 --start_t 0.7854 --tube_method OVAL --tube_wall_height 6 --closest_approach 26 --regularization 0.02
